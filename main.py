...
class YTDubPipeline:
    ...
    def dub(self, url: str, src: str, targ: str, hf_token: str, pyannotePkl: bool, turnsFinalPkl: bool):
        ...
        # 1.5. Denoise audio (Produced worse results when I was testing)
        # try:
...
if __name__ == "__main__":
    ...
    result = pipeline.dub("https://www.youtube.com/watch?v=iiYo3V9ppWo&t=692s", "en", "zh", os.getenv('HF_TOKEN'), False, False)
